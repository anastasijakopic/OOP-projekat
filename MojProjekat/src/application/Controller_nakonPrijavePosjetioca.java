...
public class Controller_nakonPrijavePosjetioca implements Initializable{
    ...
    void odjaviSe(ActionEvent event) {
		...
		try {
			...
			stage.setTitle("Ukoliko imate nalog, prijavite se!");
    ...
    @FXML
    void otkaziRezervaciju(ActionEvent event) {
    	String korisnicko;
    	...
    	try {
    		...
    		Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
    		Scene scene = new Scene(root);
    		stage.setTitle("Posjetioče " + pp.getIme() + " " + pp.getPrezime() + " , otkažite rezervaciju!");
    		stage.setScene(scene);
    		stage.show();
    	}
    	catch(IOException e) {
    		...
    		Alert alert0 = new Alert(Alert.AlertType.WARNING);
    	 	...
    	 	alert0.setContentText("Posjetioče " + pp.getIme() + " " + pp.getPrezime()  + ", Vi nemate rezervisanih karata!");
    	 	alert0.show();
    	}
    	else {
    		Alert alert0 = new Alert(Alert.AlertType.WARNING);
    	 	alert0.setTitle("UPOZORENJE");
    	 	alert0.setContentText("Posjetioče " + pp.getIme() + " " + pp.getPrezime()  + ", Vaše rezervisane karte su se vec održale.\nUkoliko želite rezervišite novu kartu!");
    	 	alert0.show();
    	}
    }
    ...
    void pregledKarata(ActionEvent event) {
    	...
    	try {
    		...
    		Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
    		Scene scene = new Scene(root);
    		stage.setTitle("Posjetioče " + pp.getIme() + " " + pp.getPrezime() + ", u prilogu je pregled karata, koje ste rezervisali putem aplikacije!");
    		stage.setScene(scene);
    		stage.show();
    	}
    	catch(IOException e) {
    		...
    		Alert alert0 = new Alert(Alert.AlertType.WARNING);
    	 	alert0.setTitle("UPOZORENJE");
    	 	alert0.setContentText("Posjetioče " + pp.getIme() + " " + pp.getPrezime()  + ", Vi nemate rezervisanih karata u aplikaciji!");
    	 	alert0.show();
    	}
    }
    ...
    //spisak pozorišta
    @FXML
    void rezervacijaK(ActionEvent event) {
    	...
    	try {
    		...
    		stage.setTitle("Posjetioče, " + imePrezime + " izaberite pozorište u kom ćete rezervisati kartu!");
    		stage.setScene(scene);
    		stage.show();
    	}
    	catch(IOException e) {
    ...
    @FXML
    void spisakOsoblja(ActionEvent event) {
    	try {
    		Parent root = FXMLLoader.load(getClass().getResource("Scena_posjetilacSpisakOsoblja.fxml.fxml"));
    		Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
    		Scene scene = new Scene(root);
    		String imePrezime;
    		if(Controller_posjetilac.prijava) {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		if(Controller_posjetilac.prijava) {
			...
			korisnciko = Controller_posjetilacRegistracija.korisnickoPosjetioicaRegistracija;
			...
			if(k.getStatus() == 2 && k.getPosjetilac_ID() == pp.getID()) {
				...
				if(Izvodjenje_predstave.obavjestenjePosjetiocu(ip.getDatum_i_vrijeme())) {
					Alert alert0 = new Alert(Alert.AlertType.INFORMATION);
		    	 	alert0.setTitle("UPOZORENJE");
		    	 	alert0.setContentText("Posjetioče " + pp.getIme() + " " + pp.getPrezime()  + ", Preuzmite Vašu rezervisanu kartu br. " + k.getBroj_karta() + ", jer je do predstave ostalo još manje od 48h!");
		    	 	alert0.show();
