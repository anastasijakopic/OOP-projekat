    ...
    void dodajIzvodjenje(ActionEvent event) {
    	if(datum.getValue() == null && hh.getText().equals("") && ss.getText().equals("") && mm.getText().equals("")) {
			   Alert alert0 = new Alert(Alert.AlertType.WARNING);
	    	 	...
	    	 	alert0.setContentText("NEOPHODNO JE DA UNESETE DATUM I VRIJEME!");
	    	 	alert0.show();
		   }
		   else if(datum.getValue() == null) {
			   Alert alert0 = new Alert(Alert.AlertType.WARNING);
	    	 	alert0.setTitle("UPOZORENJE");
	    	 	alert0.setContentText("NEOPHODNO JE DA UNESETE DATUM!");
	    	 	alert0.show();
		   }
		   else if(hh.getText().equals("") && ss.getText().equals("") && mm.getText().equals("")) {
			   Alert alert0 = new Alert(Alert.AlertType.WARNING);
	    	 	alert0.setTitle("UPOZORENJE");
	    	 	alert0.setContentText("NEOPHODNO JE DA UNESETE VRIJEME!");
	    	 	alert0.show();
		   }
		   else if(hh.getText().equals("") || ss.getText().equals("") || mm.getText().equals("")) {
			   Alert alert0 = new Alert(Alert.AlertType.WARNING);
	    	 	alert0.setTitle("UPOZORENJE");
	    	 	alert0.setContentText("NEOPHODNO JE DA POPUNITE SVA POLJA ZA SATE, MINUTE I SEKUNDE!");
	    	 	alert0.show();
		   }
			   ...
			   Alert alert0 = new Alert(Alert.AlertType.WARNING);
	    	 	alert0.setTitle("UPOZORENJE");
	    	 	alert0.setContentText("NEOPHODNO JE DA UNESETE CIJENU!");
	    	 	alert0.show();
		   }
		   else if(datum.getValue().isBefore(LocalDate.now())) {
			   Alert alert0 = new Alert(Alert.AlertType.WARNING);
	    	 	alert0.setTitle("UPOZORENJE");
	    	 	alert0.setContentText("IZABRALI STE DATUM KOJI JE PROŠAO, NEOPHODNO JE DA DODATE DATUM KOJI SLJIEDI!");
	    	 	alert0.show();
		   }
			   ...
			   Alert alert0 = new Alert(Alert.AlertType.WARNING);
	    	 	alert0.setTitle("UPOZORENJE");
	    	 	alert0.setContentText("NEISPRAVAN UNOS SATA, SVAKO POLJE MORA DA SADRŽI DVIJE CIFRE");
	    	 	alert0.show();
		   }
		   else if(datum.getValue().isEqual(LocalDate.now()) && LocalTime.parse(hh.getText() + ":" + mm.getText() + ":" + ss.getText()).isBefore(LocalTime.now()) ) {
				   Alert alert0 = new Alert(Alert.AlertType.WARNING);
		    	 	alert0.setTitle("UPOZORENJE");
		    	 	alert0.setContentText("NEISPRAVAN IZBOR SATA, IZABRALI STE VRIJEME KOJE JE PROŠLO!");
		    	 	hh.setText("");
		    	 	mm.setText("");
		    	 	ss.setText("");
		    	 	alert0.show();
		   	...
		   	alert1.setTitle("POTVRDA DODAVANJA TERMINA IZVOĐENJA");
			...
			parsed = df.parse(datumivrijeme);
				...
				connect = Konekcija.getConnection();
			   	try {
			   		if(Izvodjenje_predstave.daLiPostojiIzvodjenje( choiceBoxPredstave.getValue().getID(), Controller_nakonPrijaveRadnika.vratiPozoristeID(), cijena1, ts)){
			   		   Alert alert0 = new Alert(Alert.AlertType.WARNING);
			    	 	alert0.setTitle("UPOZORENJE");
			    	 	alert0.setContentText("Unijeto izvođenje predstave već postoji!");
			    	 	alert0.show();
			   		}
			   		else {
     		...
     		alert4.setContentText("Uspješno ste dodali izvođenje predstave!");
