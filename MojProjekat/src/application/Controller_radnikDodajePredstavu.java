...
public class Controller_radnikDodajePredstavu implements Initializable{
    	...
    	if(tf_imeAutora.getText().equals("") && tf_prezimeAutora.getText().equals("")) {
	    	...
	    	try {
	    			if(Osoblje.daLiPostojiOsoblje(3,tf_imeAutora.getText(),tf_prezimeAutora.getText())) {
	    				...
	    				alert.setContentText("Autor " + tf_prezimeAutora.getText() + ", " + tf_imeAutora.getText() + " se već nalazi u listi!\nUnesite novog autora!");
	    				alert.show();
	    			}
	    			else {
		        		...
		        		alert4.setContentText("Uspješno ste dodali autora!");
		        		alert4.show();
    ...
    @FXML
    void dodajGlumca(ActionEvent event) {
    	if(tf_imeGlumca.getText().equals("") && tf_prezimeGlumca.getText().equals("")) {
	    	...
	    	try {
	    			if(Osoblje.daLiPostojiOsoblje(1,tf_imeGlumca.getText(),tf_prezimeGlumca.getText())) {
	    				Alert alert = new Alert(Alert.AlertType.ERROR);
	    				alert.setContentText("Glumac " + tf_prezimeGlumca.getText() + ", " + tf_imeGlumca.getText() + " se već nalazi u listi!\nUnesite novog glumca!");
	    				alert.show();
	    			}
	    			else {
	    				statement = connect.prepareStatement("INSERT INTO osoblje (ime, prezime, tip) VALUE (?,?,?)");
	    				...
	    				Alert alert4 = new Alert(Alert.AlertType.INFORMATION);
		        		alert4.setTitle("OBAVJESTENJE!");
		        		alert4.setContentText("Uspješno ste dodali glumca!");
		        		alert4.show();
    ...
    @FXML
    void dodajNovogAutora(ActionEvent event) {
    ...
    @FXML
    void dodajNovogGlumca(ActionEvent event) {
    ...
    @FXML
    void dodajNovogRezisera(ActionEvent event) {
    ...
    void dodajPredstavu(ActionEvent event) {
    	if(tf_naziv.getText().equals("") && choiceBox.getValue() == null && listaGlumci.getSelectionModel().getSelectedItem() == null && listaAutori.getSelectionModel().getSelectedItem() == null && listaReziseri.getSelectionModel().getSelectedItem() == null) {
    		...
    		Alert alert4 = new Alert(Alert.AlertType.ERROR);
			alert4.setContentText("Unesite naziv i žanr predstave");
			alert4.show();
    	}
			...
			alert2.setContentText("Neophodno je da izaberete glumca, autora i režisera!");
			alert2.show();
    	}
    	else if(listaGlumci.getSelectionModel().getSelectedItem() == null ) {
    		Alert alert2 = new Alert(Alert.AlertType.ERROR);
			alert2.setContentText("Izaberite bar jednog glumca, a mozete i više ili dodajte novog glumca!");
			alert2.show();
    	}
    	else if(listaAutori.getSelectionModel().getSelectedItem() == null ) {
    		Alert alert2 = new Alert(Alert.AlertType.ERROR);
			alert2.setContentText("Izaberite tačno jednog autora ili dodajte novog autora!");
			alert2.show();
    	}
    	else if(listaReziseri.getSelectionModel().getSelectedItem() == null ) {
    		Alert alert2 = new Alert(Alert.AlertType.ERROR);
			alert2.setContentText("Izaberite tačno jednog ili dodajte novog režisera!");
			alert2.show();
    	}
    	else {
	    	connect = Konekcija.getConnection();
	    	try {
	    			if(Predstava.daLiPostojiPredstava(tf_naziv.getText(), Predstava.izStringaUInt(choiceBox.getValue()))) {
	    				Alert alert = new Alert(Alert.AlertType.ERROR);
	    				alert.setContentText("Predstava " + tf_naziv.getText() + ",žanra " + choiceBox.getValue() + " već postoji.\nUnesite novi naziv predstave!\n");
	    				alert.show();
	    			}
	    			else {
		        		...
		        		Alert alert4 = new Alert(Alert.AlertType.INFORMATION);
		        		alert4.setTitle("OBAVJESTENJE!");
		        		alert4.setContentText("Uspješno ste dodali predstavu!");
    ...
    @FXML
    void dodajRezisera(ActionEvent event) {
    	if(tf_imeRezisera.getText().equals("") && tf_prezimeRezisera.getText().equals("")) {
	    	...
	    	try {
	    			if(Osoblje.daLiPostojiOsoblje(2,tf_imeRezisera.getText(),tf_prezimeRezisera.getText())) {
	    				Alert alert = new Alert(Alert.AlertType.ERROR);
	    				alert.setContentText("Režiser " + tf_prezimeRezisera.getText() + ", " + tf_imeRezisera.getText() + " se već nalazi u listi!\nUnesite novog režisera!");
	    				alert.show();
	    			}
	    			else {
	    				statement = connect.prepareStatement("INSERT INTO osoblje (ime, prezime, tip) VALUE (?,?,?)");
	    				...
	    				Alert alert4 = new Alert(Alert.AlertType.INFORMATION);
		        		alert4.setTitle("OBAVJESTENJE!");
		        		alert4.setContentText("Uspjesno ste dodali režisera!");
		        		alert4.show();
